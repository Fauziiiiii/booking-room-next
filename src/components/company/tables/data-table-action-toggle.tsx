...
import { useDeleteCompany } from "@/lib/company/hooks/useDeleteCompany"

export default function ActionToggle({companyId}: {companyId: string}) {
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem asChild>
                        <Link href={`/super-admin/company/${companyId}`}>

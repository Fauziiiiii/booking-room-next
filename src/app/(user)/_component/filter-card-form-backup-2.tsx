...
//   const [searchValue, setSearchValue] = useState("South Jakarta");
//   const [searchCategory, setSearchCategory] = useState("city");
//   const [selectedRoomId, setSelectedRoomId] = useState<string | null>(null); // Store room ID for room category
//   const [attendees, setAttendees] = useState("1");
//   const [isDialogOpen, setIsDialogOpen] = useState(false);
//   const [date, setDate] = React.useState<Date>();
//   const [searchTerm, setSearchTerm] = useState('South Jakarta');
...
//     // If category is room, store the room ID
//     if (categoryType.toLowerCase() === 'room' && roomId) {
//       setSelectedRoomId(roomId);
//     } else {
//       setSelectedRoomId(null); // Reset room ID for other categories
//     }
//   };
...
//     // Tambahkan query parameters yang ada
//     if (attendees) {
//       queryParams.append('attendees', attendees);
//     }
...
//     // Cek kategori dan arahkan ke route yang sesuai
//     if (searchCategory === 'room' && selectedRoomId) {
//       // Jika kategori room, arahkan ke detail room
//       router.push(`/room/${selectedRoomId}?${queryParams.toString()}`);
//     } else {
//       // Untuk kategori lain (city, building), arahkan ke search
//       if (searchCategory && searchValue) {
//         queryParams.append(searchCategory, searchValue);
//       }
//       router.push(`/room/search?${queryParams.toString()}`);
...
//                       key={item.id}
//                       onClick={() =>
//                         // handleSelectItemSearch(item.name, item.type, item.type === 'room' ? item.id : undefined)
//                         handleSelectItemSearch(item.name, item.type)
//                       }
//                       className="flex items-center p-2 hover:bg-gray-100 cursor-pointer"
//                     >
//                       <FiSearch className="mr-3 text-gray-500" size={20} />
...
//                           item.name, 
//                           item.type,
//                           item.type === 'room' ? item.id : undefined
//                         )
//                       }
//                       className="flex items-center p-2 hover:bg-gray-100 cursor-pointer"
//                     >
